...
You can read more about [memory leaks and other pitfalls of closures](../what-are-the-potential-pitfalls-of-using-closures/main) and the [module pattern and private state](../how-can-closures-be-used-to-create-private-variables/main) on their dedicated pages.
...
_Source: [greatfrontend/top-javascript-interview-questions](https://github.com/greatfrontend/top-javascript-interview-questions/blob/main/questions/what-is-a-closure-and-how-why-would-you-use-one/en-US.mdx)_
