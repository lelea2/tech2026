...
![ML lifecycle feedback loop](./assets/checkpoint_eval_sequence_diagram.png)
...
![ML lifecycle feedback loop](./assets/model_promotion_gate_flow_chart.png)
...
![ML lifecycle feedback loop](./assets/eval_metric_mapping_flow_chart.png)
