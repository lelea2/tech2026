...
A recommendation system turns user behavior, item metadata, and business constraints into a ranked list of items. The design challenge is not simply choosing a machine-learning model. It is building a globally distributed system that can ingest billions of events, train and serve models consistently, adapt to recent intent, remain explainable and safe, and return useful results within a strict latency budget.

This guide presents a production-grade design for an e-commerce recommendation platform. The same architecture applies to video, music, social, jobs, and news feeds.
