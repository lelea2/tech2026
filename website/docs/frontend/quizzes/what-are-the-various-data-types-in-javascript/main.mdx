...
- **Symbol**: A unique and immutable value used as object property keys. Read more in our [deep dive on `Symbol`s](../what-are-symbols-used-for/main).
...
_Source: [greatfrontend/top-javascript-interview-questions](https://github.com/greatfrontend/top-javascript-interview-questions/blob/main/questions/what-are-the-various-data-types-in-javascript/en-US.mdx)_
