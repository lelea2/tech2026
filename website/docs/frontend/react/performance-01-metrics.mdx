---
title: "React Performance Metrics: Core Web Vitals & DevTools Profiler"
sidebar_position: 45
---
...
> Source: [performance-01-metrics.md](https://github.com/maurya-sachin/Frontend-Master-Prep-Series/blob/main/03-react/performance-01-metrics.md)
