---
title: "React Patterns: Higher-Order Components (HOCs)"
sidebar_position: 33
---
...
> Source: [patterns-02-hoc.md](https://github.com/maurya-sachin/Frontend-Master-Prep-Series/blob/main/03-react/patterns-02-hoc.md)
