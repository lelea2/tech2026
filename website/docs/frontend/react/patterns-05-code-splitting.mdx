---
title: "React Patterns: Code Splitting and Lazy Loading"
sidebar_position: 43
---
...
> Source: [patterns-05-code-splitting.md](https://github.com/maurya-sachin/Frontend-Master-Prep-Series/blob/main/03-react/patterns-05-code-splitting.md)
