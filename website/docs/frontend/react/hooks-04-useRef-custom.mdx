---
title: "React Hooks - Advanced useRef and Custom Hooks with Refs"
sidebar_position: 22
---
...
> Source: [hooks-04-useRef-custom.md](https://github.com/maurya-sachin/Frontend-Master-Prep-Series/blob/main/03-react/hooks-04-useRef-custom.md)
