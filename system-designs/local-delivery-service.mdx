...
Design a system that allows **consumers to order food/goods from restaurants/stores**, **matches them with available drivers**, **tracks delivery in real-time**, and **ensures reliable payment processing**. This is a geo-distributed, real-time matching problem with tight SLA requirements.
